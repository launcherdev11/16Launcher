...
class ModLoaderInstaller(QThread):
    ...
    def install_optifine(self):
        ...
        try:
            ...
            self.finished_signal.emit(
                False, f"Ошибка установки OptiFine: {e!s}",
            )

    def install_quilt(self):
        try:
            from minecraft_launcher_lib.quilt import (
                install_quilt as quilt_install,
            )
    ...
    def install_forge(self):
        ...
        try:
            ...
            self.finished_signal.emit(
                True, f"Forge {forge_version} установлен!",
            )
    ...
    def get_callback(self):
        ...
        return {
            ...
            "setProgress": lambda value: self.progress_signal.emit(
                value, 100, "",
            ),
